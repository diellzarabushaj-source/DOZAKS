...
(() => {
  ...
  function init() {
    ...
    loadScriptOnce('/smart-search-ui.js?v=local-index-20260722', 'dozaks-smart-search');
    loadScriptOnce('/product-catalog.js?v=local-index-20260722', 'dozaks-product-catalog');
    loadScriptOnce('/search-audit-client.js?v=phase2-20260722', 'dozaks-search-audit');
